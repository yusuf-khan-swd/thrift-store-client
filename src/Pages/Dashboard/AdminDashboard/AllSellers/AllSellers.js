          ...
          <tbody>
            {
              sellers.map((seller, index) => <tr key={seller._id}>
                ...
                <td>
                  <button className="btn btn-error btn-xs text-gray-600 font-bold mr-4">Delete</button>
                  <button className="btn btn-primary btn-xs text-gray-600 font-bold">Verify</button>
                </td>
              </tr>
              )
            }
