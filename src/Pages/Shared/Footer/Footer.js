...
const Footer = () => {
  ...
  return (
    <footer className="p-6 dark:bg-gray-800 dark:text-gray-100">
      <div className="container grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4">
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex flex-col space-y-2 text-sm dark:text-gray-400">
            ...
            <Link className='hover:link'>IntelliSense</Link>
          </div>
        </div>
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex flex-col space-y-2 text-sm dark:text-gray-400">
            ...
            <Link className='hover:link'>Adding New Utilities</Link>
          </div>
        </div>
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex flex-col space-y-2 text-sm dark:text-gray-400">
            ...
            <Link className='hover:link'>Customizing Spacing</Link>
            <Link className='hover:link'>Configuring Variants</Link>
            <Link className='hover:link'>Plugins</Link>
          </div>
        </div>
        <div className="flex flex-col space-y-4">
      ...
      <div className="px-6 pt-12 text-sm">
