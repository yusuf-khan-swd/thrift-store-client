      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 bg-white shadow-xl rounded-lg max-w-6xl mx-auto border">
        <div className="m-2">
          <figure className="h-full w-full">
            <img src={image} className="h-full w-full rounded-lg border" alt={productName} />
          </figure>
        </div>
        <div className="card lg:col-span-2 text-zinc-500">
          <div className="card-body">
            ...
            <div>
              ...
              <p className="mb-3"><span className="font-medium">Description:</span> {description.length > 200 ? description.slice(0, 198) + '...' : description}</p>
            </div>
